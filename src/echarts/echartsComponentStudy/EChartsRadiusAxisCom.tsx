...
import { RadiusAxis } from '../../types/echarts'

//radiusAxis:半径轴组件,在使用极坐标系(polar)时使用

export default defineComponent({
    components: { Base },
    setup() {
        const css: CSSProperties = { width: '300px', height: '300px', border: 'solid 1px #000' }
        const radiusAxis: RadiusAxis = {
            min: 0,
            axisLine: {
                show: false,
            },
        ...
        const option: EChartOption = {
            ...
            series: [{
                ...
                data: [
                    ...
                    [-0.49969541350954777, 337],
                    [-0.4996954135095478, 338],
                    [-0.49726094768413676, 339],
